...
def main():
    ...
    ship1_ver2 = gen_random_ship(board1, 1, 3, "ver")
    ship1_hor1 = gen_random_ship(board1, 1, 2, "hor")
    ship1_hor2 = gen_random_ship(board1, 1, 3, "hor")

    # creating ships on player2's board
    ship2_ver1 = gen_random_ship(board2, 1, 4, "ver")
    ship2_ver2 = gen_random_ship(board2, 1, 3, "ver")
    ship2_hor1 = gen_random_ship(board2, 1, 3, "hor")
    ship2_hor2 = gen_random_ship(board2, 1, 2, "hor")
